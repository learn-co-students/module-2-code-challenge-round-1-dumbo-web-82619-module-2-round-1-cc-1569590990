...
Guest >-< Episode .... Guest -< Appearance >- Episode

<!-- Appearance: guest_id, episode_id, guest_rating  -->
...
NEED:
<!-- -new for appearance (form: guest, episode, rating) -->
<!-- -create for appearance (redirect to episode show page) -->
<!-- -show for episode (all guests in episode) -->
<!-- -index for guest -->
<!-- -show for guest (name, occupation) -->
